...
- **Impact**: The master, after receiving several bad packets on the request server equal to the number of worker threads, will become unresponsive to return requests, until restarted.
