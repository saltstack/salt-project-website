---
title: "Salt 3008.2 LTS Now Available"
summary: "The Salt Project has just released 3008.2 (LTS Release)."
date: "2026-07-01"
...
# Salt Project Announcement: Salt 3008.2 LTS is Here!

The Salt Project has just released the 3008.2 LTS bugfix version of Salt.

* **Release Notes:** View the release notes on [GitHub](https://github.com/saltstack/salt/blob/3008.x/doc/topics/releases/3008.2.md)
* **Changelogs:** https://github.com/saltstack/salt/blob/v3008.2/CHANGELOG.md
* **The Tag:** Check out the official ``v3008.2`` tag on [GitHub](https://github.com/saltstack/salt/releases/tag/v3008.2)

## Installation & Upgrade Notes

Users can install Salt 3008.2 via PyPI or through our official package repositories.
...
* **Package Repo:** Packages are available here:
  ...
  * [mac](https://packages.broadcom.com/artifactory/saltproject-generic/macos/3008.2/)
  * [win](https://packages.broadcom.com/artifactory/saltproject-generic/windows/3008.2/)
  * [onedir](https://packages.broadcom.com/artifactory/saltproject-generic/onedir/3008.2/)
...
* **PyPI Source:** Download the package directly via [PyPI](https://pypi.org/project/salt/3008.2/)
