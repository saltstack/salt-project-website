---
title: "Salt 3006.27 LTS Now Available"
summary: "The Salt Project has just released 3006.27 (LTS Release)."
date: "2026-07-01"
...
# Salt Project Announcement: Salt 3006.27 LTS is Here!

The Salt Project has just released the 3006.27 LTS bugfix version of Salt.

* **Release Notes:** View the release notes on [GitHub](https://github.com/saltstack/salt/blob/3006.x/doc/topics/releases/3006.27.md)
* **Changelogs:** https://github.com/saltstack/salt/blob/v3006.27/CHANGELOG.md
* **The Tag:** Check out the official ``v3006.27`` tag on [GitHub](https://github.com/saltstack/salt/releases/tag/v3006.27)

## Installation & Upgrade Notes

Users can install Salt 3006.27 via PyPI or through our official package repositories.
...
* **Package Repo:** Packages are available here:
  ...
  * [mac](https://packages.broadcom.com/artifactory/saltproject-generic/macos/3006.27/)
  * [win](https://packages.broadcom.com/artifactory/saltproject-generic/windows/3006.27/)
  * [onedir](https://packages.broadcom.com/artifactory/saltproject-generic/onedir/3006.27/)
...
* **PyPI Source:** Download the package directly via [PyPI](https://pypi.org/project/salt/3006.27/)
