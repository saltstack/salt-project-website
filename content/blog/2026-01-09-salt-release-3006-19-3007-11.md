---
title: "Salt 3006.19 LTS and 3007.11 STS are available"
summary: "The Salt Project has just released the 3006.19 LTS and 3007.11 STS bugfix releases of Salt"
date: "2026-01-09" # UPDATE!
...
The Salt Project has just released 3006.19 LTS and 3007.11 STS bugfix releases
of Salt. To download and install Salt 3006.19 LTS and 3007.11 STS, see the
[Salt install guide](https://docs.saltproject.io/salt/install-guide/en/latest/).

- Release notes:
    - https://docs.saltproject.io/en/3006/topics/releases/3006.19.html
    - https://docs.saltproject.io/en/3007/topics/releases/3007.11.html
- Changelogs:
    - https://github.com/saltstack/salt/blob/v3006.19/CHANGELOG.md
    - https://github.com/saltstack/salt/blob/v3007.11/CHANGELOG.md
- Sources are available on PyPI:
    - https://pypi.org/project/salt/3006.19/
    - https://pypi.org/project/salt/3007.11/
