---
title: "Salt 3007.14 STS is available"
summary: "The Salt Project has just released the 3007.14 STS bugfix release!"
date: "2026-04-29" # UPDATE!
...
The Salt Project has just released the 3007.14 STS bugfix release of Salt. To
download and install, see the
[Salt install guide](https://docs.saltproject.io/salt/install-guide/en/latest/).

**Salt 3007.14 STS**

- Release notes: https://docs.saltproject.io/en/3007/topics/releases/3007.14.html
- Changelogs: https://github.com/saltstack/salt/blob/v3007.14/CHANGELOG.md
- Sources are available on PyPI: https://pypi.org/project/salt/3007.14/
